...
Calendar.prototype.getMonthlyCalendarCode = function() {
	...
	vCode = vCode + "<TABLE WIDTH='" + (v_Width-30) + "' BORDER=0 BGCOLOR=\"#999999\">";
...
Calendar.prototype.onclickfn = function() {
	...
	var retCode = "apchar = ''" +
				...
				whois + apchar + "apchar + pday.substr(0,4) + pday.substr(4,2).toLowerCase() + + pday.substr(6);\n";
	return retCode;
}
...
Calendar.prototype.show = function() {
	...
	this.wwrite("<TABLE WIDTH='" + (v_Width-30) + "' BORDER=0 CELLPADDING=0 BGCOLOR='#ffffff'><TR><TD>" +
		"<TABLE BORDER=0 WIDTH='100%' CELLPADDING=1 BGCOLOR='#ffffff'>" +
		"<TR>");

	this.wwrite("<TD BGCOLOR='#ffffff' COLSPAN=2>");
	...
	if (v_Nav == "Yes") {
		this.wwrite("<TABLE WIDTH='" + (v_Width-30) + "' BORDER=0 CELLSPACING=0 CELLPADDING=3 BGCOLOR='#ffffff'><TR><TD ALIGN=center>");
...
Calendar.prototype.showY = function() {
	...
	this.wwrite("<TABLE WIDTH='" + (v_Width-30) + "' BORDER=0 CELLSPACING=0 CELLPADDING=0 BGCOLOR='#cccccc'><TR><TD ALIGN=center>");
	this.wwrite("[<A HREF=\"" +
