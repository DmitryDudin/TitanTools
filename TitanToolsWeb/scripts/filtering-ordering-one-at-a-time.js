...
var NOT_ORDERED_STR="Not ordered";
var ASCENDING_STR="Ascending";
var DESCENDING_STR="Descending";
...
function updateOrdering(anchor, orderElement) {
	clearOrderExcept(anchor, orderElement);
...
function clearOrderExcept(exceptAnchor, exceptEl) {
	var f = document.forms[0];
	for (var i in sortElementsMap) {
		var key = "f." + i;
		var el = eval(key);
